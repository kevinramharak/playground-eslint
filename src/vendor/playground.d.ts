...
export declare const setupPlayground: (sandbox: Sandbox, monaco: Monaco, config: PlaygroundConfig, i: (key: string) => string, react: any) => {
    exporter: {
        openProjectInStackBlitz: () => void;
        openProjectInCodeSandbox: () => void;
        copyAsMarkdownIssue: (e: any) => Promise<boolean>;
        copyForChat: (e: any) => boolean;
        copyForChatWithPreview: (e: any) => boolean;
        openInTSAST: () => void;
